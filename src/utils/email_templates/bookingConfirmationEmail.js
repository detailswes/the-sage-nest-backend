      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr><td style="background:#ffffff;border-radius:16px;border:1px solid #c5ceba;padding:40px 36px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding-bottom:12px;">
                  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#5e6d5b;letter-spacing:0.5px;">Expert</span><br>
              ...
              <tr>
                <td style="padding:12px 0;border-top:1px solid #c5ceba;">
                  ...
                  <span style="font-size:15px;font-weight:600;color:#445446;">${timeStr} UTC</span>
                </td>
              </tr>
              <tr>
                <td style="padding:12px 0;border-top:1px solid #c5ceba;">
              ...
              <tr>
                <td style="padding-top:12px;border-top:1px solid #c5ceba;">
                  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#5e6d5b;letter-spacing:0.5px;">Location</span><br>
          ...
          <ul style="margin:0 0 12px;padding-left:20px;">
            <li style="font-size:14px;color:#5e6d5b;line-height:1.7;margin-bottom:4px;"><strong>More than 24 hours</strong> before your session &rarr; Full refund</li>
            <li style="font-size:14px;color:#5e6d5b;line-height:1.7;margin-bottom:4px;"><strong>Between 12 and 24 hours</strong> before your session &rarr; 50% refund</li>
            <li style="font-size:14px;color:#5e6d5b;line-height:1.7;"><strong>Less than 12 hours</strong> before your session or no-show &rarr; No refund</li>
          </ul>
          <p style="margin:0 0 8px;font-size:14px;color:#5e6d5b;line-height:1.6;">
          ...
          <!-- Sign-off -->
          <p style="margin:0 0 4px;font-size:14px;color:#5e6d5b;line-height:1.6;">We hope the session is everything you need.</p>
